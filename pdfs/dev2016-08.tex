...
\iffalse
\section{前回授業の補足}
\subsection{DOM4におけるプロパティ}
\begin{frame}
 \begin{table}[ht]
\caption{DOM要素に対するプロパティ(1)}
\begin{center}
 \begin{tabular}{|c|m{20zw}|}
  \hline
プロパティ名  &
...
\LISTN{09-01event.html}{1}{7}{\small}
CSSファイル、JavaScriptファイルが外部ファイル
\end{frame}
\begin{frame}[containsverbatim]
\frametitle{ファイルのリスト(2)}
\LISTN{09-01event.html}{8}{11}{\small}
\end{frame}
\begin{frame}[containsverbatim]
\frametitle{ファイルのリスト(3)}
\LISTN{09-01event.html}{12}{26}{\footnotesize}
\end{frame}
\begin{frame}[containsverbatim]
\frametitle{ファイルのリスト(4)}
\LISTN{09-01event.html}{27}{last}{\footnotesize}
\end{frame}
\begin{frame}[containsverbatim]
\frametitle{CSSファイル(1)---左部分}
\LISTN{event.css}{1}{9}{\footnotesize}
\end{frame}
\begin{frame}[containsverbatim]
...
\LISTN{event.css}{10}{22}{\footnotesize}
\end{frame}
\begin{frame}[containsverbatim]
\frametitle{CSSファイル(3)---右部分(続き)}
\LISTN{event.css}{23}{last}{\footnotesize}
\end{frame}
\begin{frame}[containsverbatim]
...
\LISTN{event.js}{1}{8}{\footnotesize}
ここでは\texttt{id}属性を持つ要素すべてを得ている。
\end{frame}
\begin{frame}[containsverbatim]
\frametitle{JavaScript(2)}
\LISTN{event.js}{9}{12}{\footnotesize}
\begin{itemize}
...
\begin{frame}[containsverbatim]
\frametitle{}
\LISTN{event.js}{13}{25}{\footnotesize}
...
\LISTN{event.js}{36}{38}{\footnotesize}
...
\begin{frame}[containsverbatim]
\frametitle{リスト(1)}
\LISTN{09-03pulldown.html}{1}{17}{\footnotesize}
...
\begin{frame}[containsverbatim]
\frametitle{リスト(2)}
\LISTN{09-03pulldown.html}{18}{26}{\footnotesize}
\end{frame}
\begin{frame}[containsverbatim]
\frametitle{リスト(2)---解説}
...
\begin{frame}[containsverbatim]
\frametitle{リスト(3)}
\LISTN{09-03pulldown.html}{27}{29}{\footnotesize}
関数\texttt{makeTextNode()}は指定された文字列を基にテキストノードを作成
 し、指定された親要素の子要素に設定している。
\end{frame}
\begin{frame}[containsverbatim]
\frametitle{リスト(4)}
\LISTN{09-03pulldown.html}{30}{36}{\footnotesize}
...
\begin{frame}[containsverbatim]
\frametitle{リスト(5)}
\LISTN{09-03pulldown.html}{37}{42}{\footnotesize}
...
\begin{frame}[containsverbatim]
\frametitle{リスト(6)}
\LISTN{09-03pulldown.html}{43}{54}{\footnotesize}
\end{frame}
\begin{frame}[containsverbatim]
\frametitle{リスト(6)---解説}
...
\begin{frame}[containsverbatim]
\frametitle{リスト(7)}
\LISTN{09-03pulldown.html}{55}{last}{\footnotesize}
